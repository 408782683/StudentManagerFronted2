<template>
  <el-card shadow="hover" class="data-card">
    ...
    <el-form :model="student" label-width="90px" :inline="true">
      <el-form-item label="ID"><el-input v-model="student.id" type="number" placeholder="留空新增" class="input-short" /></el-form-item>
    ...
    <el-table :data="students" class="data-table" height="520">
